...
def calculate_parkings(vecID, curr_edgeID, last_edgeID, last_laneID_excpected, expected_index):
    ...
    list_parking = get_ordred_parkings(list_aviable_lane)

    vecID_to_list_parking[vecID] = True

    # Recupero il parcheggio attuale con più posti liberi
    ...
    while traci.simulation.getMinExpectedNumber() != 0:
        ...
        for vecID in curr_vehicles_List:
            ...
            if traci.vehicle.isStoppedParking(vecID) is False:
                ...
                # print("curr_edgeID:", curr_edgeID, "last_edgeID:", last_edgeID, "space_on_next:", space_on_next_step, "dist_to_last:", distance_to_lastedge, "curr_laneID:", curr_laneID)
                # print("index:", curr_lane_index)
                ...
                if space_on_next_step >= distance_to_lastedge:
                    ...
                    if vecID_to_list_parking.get(vecID) is True and vecID_to_parkingID_dictionary.get(vecID) is None:
                        ...
                        if parkingID is not None and check_parking_aviability(parkingID) is True and check_parking_position(vecID, curr_position, parkingID) is True:
                            ...
                            print("No parcheggio lungo la strada corrente")
            else:
