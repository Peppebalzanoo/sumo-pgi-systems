        ...
        for vecID in currVehiclesList:
            ...
            if not traci.vehicle.isStoppedParking(vecID):
                ...
                """if currEdgeID == lastEdgeID:
                    ...
                    # print("##########################################################")
                    # (currLength - currPosition) è quello che manca alla prossima edge
                    spaceForSecond = (currLength-currPosition) + getSpace(currAcc, currSpeed)
                """


                #print("currEdge: "+str(currEdgeID)+" , currLane: "+str(currLaneID))
                #print("Distance To Last: "+str(distanceToLastEdge)+", spaceForSecond: "+ str(spaceForSecond))
                #print("lastEdge: "+str(lastEdgeID))
