    ...
    if count == TIME_SLICE:
        if vecID_dynamicarea_counter_dictionary.get(vecID)[1] < 3:
            ...
            print("     Sono passati", TIME_SLICE, "steps",
                  "Il veicolo ritornerà alla sua destinazione iniziale: " + str(destination_edgeXML) + " perchè NON è possibile aumentare la superficie")
            send_to_destinationXML(vecID)
            reset_dynamicarea_counter(vecID)
            reset_vec_searchtime_dictionary(vecID)
...
def run():
    ...
    while traci.simulation.getMinExpectedNumber() != 0:
        ...
        print(destedges_tupleposXY_dictionary)
        ...
        for vecID in currVehiclesList:
            ...
            if traci.vehicle.isStoppedParking(vecID) is False:
                ...
                print("    # space2:", space_on_next_step)
