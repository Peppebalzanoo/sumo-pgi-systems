...
def get_index_calculated(edgeID, curr_lane_index):
    ...
    if curr_lane_index == 0 or (curr_lane_index != 0 and curr_lane_index in list_indexes):
...
def check_parking_setted(vecID, parkingID):
        ...
        if parkingID is not None:
            ...
            if check_parkingaviability(parkingID):
                try:
                    ...
                    if check_parking_setted(vecID, parkingID) is False:
